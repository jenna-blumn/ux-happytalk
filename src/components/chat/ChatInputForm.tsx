...
function HAiAssistantText() {
  return (
    <div className="content-stretch flex flex-col items-start justify-center relative shrink-0" data-name="hAI assistant text">
      <p className="bg-clip-text font-sans font-bold leading-[16px] not-italic relative shrink-0 text-[16px] text-center text-nowrap tracking-[-0.43px] whitespace-pre" style={{ WebkitTextFillColor: "transparent" }}>
        AI
      </p>
    </div>
  );
  ...
  return (
    <div className="basis-0 content-stretch flex gap-[4px] grow items-center min-h-px min-w-px relative shrink-0">
      <div className="bg-white box-border content-stretch flex gap-[4px] h-[30px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0" data-name="Ai_btn">
        <div aria-hidden="true" className="absolute shadow-sort-card ring-1 ring-zinc-900/10 ring-inset border-none" />
        <Heart />
        <p className="font-sans font-normal leading-[20px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-zinc-800 text-[14px] text-nowrap tracking-[-0.28px] whitespace-pre">친절하게</p>
      </div>
      <div className="bg-white box-border content-stretch flex gap-[4px] h-[30px] items-center px-[12px] py-[4px] relative rounded-[8px] shrink-0" data-name="Ai_btn">
        <div aria-hidden="true" className="absolute shadow-sort-card ring-1 ring-zinc-900/10 ring-inset border-none" />
        <Check />
        <p className="font-sans font-normal leading-[20px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-zinc-800 text-[14px] text-nowrap tracking-[-0.28px] whitespace-pre">맞춤법</p>
      </div>
    </div>
  );
}
...
function CounselorMessage() {
  return (
    <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full" data-name="Counselor Message">
      <div className="basis-0 font-sans font-normal grow leading-[22px] min-h-px min-w-px not-italic relative shrink-0 text-zinc-500 text-[15px] tracking-[-0.23px]">
...
function Frame() {
  return (
    <div className="bg-white relative rounded-[8px] shadow-sort-card ring-1 ring-zinc-900/5 ring-inset shrink-0 w-full">
      <div className="size-full">
