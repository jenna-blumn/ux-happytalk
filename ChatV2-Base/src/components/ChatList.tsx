...
function SelectOption({ label }: { label: string }) {
  return (
    <div className="bg-white box-border content-stretch flex items-center pl-[8px] pr-[4px] py-[4px] relative rounded-[4px] shrink-0" data-name="option">
      ...
      <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[1.2] not-italic opacity-80 relative shrink-0 text-[13px] text-nowrap text-zinc-900 tracking-[-0.26px] whitespace-pre">{label}</p>
      <CaretDownIcon />
    </div>
  );
}
    ...
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[4px] shrink-0" data-name="option">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex items-center pl-[8px] pr-[4px] py-[4px] relative w-full">
          <p className="basis-0 font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] grow leading-[1.2] min-h-px min-w-px not-italic opacity-80 relative shrink-0 text-[13px] text-zinc-900 tracking-[-0.26px]">{label}</p>
          <CaretDownIcon />
        </div>
      </div>
    </div>
...
function Component1Row({ content }: { content: string }) {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full" data-name="1row">
      <Syncicon />
      <p className="[white-space-collapse:collapse] basis-0 font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] grow leading-[1.4] min-h-px min-w-px not-italic opacity-80 overflow-ellipsis overflow-hidden relative shrink-0 text-[14px] text-nowrap text-zinc-900 tracking-[-0.28px]">{content}</p>
    </div>
  );
}
...
function BadgeCall({ platform, status }: { platform: string; status: string }) {
  return (
    <div className="bg-neutral-50 box-border content-stretch flex gap-[4px] h-[24px] items-center leading-[16px] not-italic overflow-clip p-[4px] relative rounded-[4px] shrink-0 text-[12px] text-nowrap text-zinc-900 whitespace-pre" data-name="badge-call">
      <p className="font-['Spoqa_Han_Sans_Neo:Bold',sans-serif] opacity-75 relative shrink-0 tracking-[-0.24px]">{platform}</p>
      <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] opacity-75 relative shrink-0">{status}</p>
    </div>
  );
}
...
function Time({ time }: { time: string }) {
  return (
    <div className="content-stretch flex gap-[4px] items-end justify-end relative shrink-0" data-name="time">
      <p className="font-['Spoqa_Han_Sans_Neo:Regular',sans-serif] leading-[18px] not-italic relative shrink-0 text-[#306afe] text-[13px] text-nowrap text-right tracking-[-0.26px] whitespace-pre">{time}</p>
    </div>
  );
}
